# k8s_cloudsql_proxy.tf configures a service within the cluster which proxies
# the Cloud SQL instance so that it is available for pods.
#
...
#
# Related issue: https://gitlab.com/charts/gitlab/issues/585
